...
## Native2Native
<br><i>"A Voice and Text Recognition System Built Specifically for Non-Native Speakers"</i><br>
...
A [Seq2Seq Recurrent Neural Network](https://arxiv.org/pdf/1409.3215.pdf) is used to train on these "non-native/incomplete" sentences and maps them to "complete" sentences. The model was trained using an [AWS](https://aws.amazon.com/) EC2 P2 instance equipped with a [NVIDIA Tesla K80 GPU](https://www.nvidia.com/en-us/data-center/tesla-k80/). [Image from here](https://google.github.io/seq2seq/) More specifically, more model was a variation of [SimpleText](https://github.com/captainjtx/SimpleText), a RNN that explores the task of simplifying long sentences. (Basically, our project did the reverse)
